	                                    		...
	                                    		<tr>
			                                        ...
			                                        <td>
			                                        	<g:if test="${job?.invoice && (job?.invoiceStatus?.equals('INVOICE_SENT') || job?.invoiceStatus?.equals('INVOICE_PAID'))}">
			                                        		<button type="button" class="btn btn-white btn-sm" onclick="openInvoiceModalForCustomer('${job?.id}');"><i class="fa fa-money"></i> View </button>
			                                        	</g:if>
			                                        </td>
        ...
        <div class="modal inmodal" id="myModal" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content animated bounceInRight">
            		...
            		<g:form name="createNewJob_customer" controller="jobs" action="createNewJobCustomer" id="${customerInstance?.id}">
	            		<div class="modal-body col-md-12">
							...
							<div class="form-group col-md-6 required">
								...
								<input type="text" placeholder="Address Line 1" name="addressLine1" id="addressLine1_create" class="form-control" value="${customerInstance?.addressLine1}" required>
							</div>
							<div class="form-group col-md-6">
								<label class='control-label'>Address Line 2</label> 
								<input type="text" placeholder="Address Line 2" name="addressLine2" id="addressLine2_create" class="form-control" value="${customerInstance?.addressLine2}">
							</div>
							<div class="form-group col-md-6">
								<label class='control-label'>Address Line 3</label> 
								<input type="text" placeholder="Address Line 3" name="addressLine3" id="addressLine3_create" class="form-control" value="${customerInstance?.addressLine3}">
							</div>
							<div class="form-group col-md-6 required">
								<label class='control-label'>Post Code</label> 
								<input type="text" placeholder="Post Code" name="postcode" id="postcode_create" class="form-control" value="${customerInstance?.postcode}" required>
							</div>
