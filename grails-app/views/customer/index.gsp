        ...
        <div class="col-md-12 page-wrapper">
            <div class="ibox float-e-margins">
                <div class="ibox-content"  style="border: 0px;">
                	<g:uploadForm controller='customer' method="post" action='uploadProfilePicture'>
                		<div id="showProfilePicture" class="col-md-3" class="no-padding border-left-right col-md-4" style="clear: left; float: left;">
                			<g:if test="${customerInstance?.profilePic}">
                				<img src="${createLink(controller:'customer', action:'viewProfilePic')}" alt="your image" style="width: 100%; height: 100%;" />
                			</g:if>
                		</div>
                ...
                <div class="ibox-content">
                    <g:form controller="customer" action="updateProfile" id="${customerInstance?.id}">
                    	...
                    	<div class="col-md-4">
							<div class="form-group required">
								...
								<input type="text" placeholder="Contact Name" class="form-control" value="${customerInstance?.name}" name="name" required>
							</div>
                       	</div>
                       	<div class="col-md-4">
							<div class="form-group required">
								<label class="control-label">Email</label>
								<input type="email" placeholder="Email" class="form-control" value="${customerInstance?.email}" name="companyEmail" disabled="disabled">
							</div>
                       	</div>
                       	...
                       	<div class="col-md-4">
							<div class="form-group required">
								...
								<input type="text" placeholder="Address Line 1" class="form-control" value="${customerInstance?.addressLine1}" name="addressLine1" required>
							</div>
                       	</div>
                       	<div class="col-md-4">
							<div class="form-group">
								<label>Address Line 2</label>
								<input type="text" placeholder="Address Line 2" class="form-control" value="${customerInstance?.addressLine2}" name="addressLine2">
							</div>
                       	</div>
                       	<div class="col-md-4">
							<div class="form-group">
								<label>Address Line 3</label>
								<input type="text" placeholder="Address Line 3" class="form-control" value="${customerInstance?.addressLine3}" name="addressLine3">
							</div>
                       	</div>
                       	<div class="col-md-4">
							<div class="form-group required">
								<label class="control-label">Post Code</label>
								<input type="text" placeholder="Post Code" class="form-control" value="${customerInstance?.postcode}" name="postcode" required>
							</div>
                       	</div>
                       	<div class="col-md-4">
							<div class="form-group">
								<label>Phone</label>
								<input type="text" placeholder="Phone" class="form-control" value="${customerInstance?.phone}" name="phone">
							</div>
                       	</div>
                       	...
                       	<div class="col-md-12">
                       		<div class="form-group">
								...
								<g:if test="${customerInstance?.paymentMethod?.contains('PayPal')}">
								...
								<g:if test="${customerInstance?.paymentMethod?.contains('AmazonPay')}">
