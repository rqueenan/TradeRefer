                		...
                		<li>
                			<div class="avatar">
                				<g:if test="${customer?.profilePic}">
	                        		<g:link controller="profile" action="index"><img class="Photo" style="width: 100%; height: 100%; border-radius: 100%;  border: 2px solid #1ab394;" src="${createLink(controller:'profile', action:'viewProfilePic')}" /></g:link>
	                        	</g:if>
	                        	<g:else>
	                        		<g:link controller="profile" action="index"><img style="width: 100%; height: 100%; border-radius: 100%; border: 2px solid #1ab394;" src="https://graph.facebook.com/${customer?.UID}/picture?type=small" /></g:link>
	                        	</g:else>
                			</div>
                		</li>
                		<li>
                    		<%--<a href="#" onclick="logoutFb();">
                        		--%>
                        	<a href="/logout">
