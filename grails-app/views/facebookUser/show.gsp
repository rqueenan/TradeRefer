...
<html>
    ...
    <body>
        ...
        <div id="show-facebookUser" class="content scaffold-show" role="main">
            ...
            <f:display bean="facebookUser" />
            <g:form resource="${this.facebookUser}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.facebookUser}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
