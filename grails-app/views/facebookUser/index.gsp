        ...
        <div class="col-md-12 page-wrapper">
            <div class="ibox float-e-margins">
                <div class="ibox-content"  style="border: 0px;">
                	<g:uploadForm controller='facebookUser' method="post" action='uploadProfilePicture'>
                		<div id="showProfilePicture" class="col-md-3" class="no-padding border-left-right col-md-4" style="clear: left; float: left;">
                			<g:if test="${fbUser?.profilePic}">
                				<img src="${createLink(controller:'facebookUser', action:'viewProfilePic')}" alt="your image" style="width: 100%; height: 100%;" />
                			</g:if>
                			<g:else>
                				<img src="https://graph.facebook.com/${fbUser?.UID}/picture?type=large" style="width: 100%; height: 100%;" />
                			</g:else>
                		</div>
                ...
                <div class="ibox-content">
                    <g:form controller="facebookUser" action="updateProfile" id="${fbUser?.id}">
                    	...
                    	<div class="col-md-4">
							<div class="form-group required">
								...
								<input type="text" placeholder="Contact Name" class="form-control" value="${fbUser?.name}" name="name" required>
							</div>
                       	</div>
                       	<div class="col-md-4">
							<div class="form-group required">
								<label class="control-label">Email</label>
								<input type="email" placeholder="Email" class="form-control" value="${fbUser?.email}" name="companyEmail" disabled="disabled">
							</div>
                       	</div>
                       	...
                       	<div class="col-md-4">
							<div class="form-group required">
								...
								<input type="text" required placeholder="Address Line 1" class="form-control" value="${fbUser?.addressLine1}" name="addressLine1">
							</div>
                       	</div>
                       	<div class="col-md-4">
							<div class="form-group">
								<label>Address Line 2</label>
								<input type="text" placeholder="Address Line 2" class="form-control" value="${fbUser?.addressLine2}" name="addressLine2">
							</div>
                       	</div>
                       	<div class="col-md-4">
							<div class="form-group">
								<label>Address Line 3</label>
								<input type="text" placeholder="Address Line 3" class="form-control" value="${fbUser?.addressLine3}" name="addressLine3">
							</div>
                       	</div>
                       	<div class="col-md-4">
							<div class="form-group required">
								<label class="control-label">Post Code</label>
								<input type="text" required placeholder="Post Code" class="form-control" value="${fbUser?.postcode}" name="postcode">
							</div>
                       	</div>
                       	<div class="col-md-4">
							<div class="form-group">
								<label>Phone</label>
								<input type="text" placeholder="Phone" class="form-control" value="${fbUser?.phone}" name="phone">
							</div>
                       	</div>
                       	...
                       	<div class="col-md-12">
                       		<div class="form-group">
								...
								<g:if test="${fbUser?.paymentMethod == 'PayPal'}">
								...
								<g:if test="${fbUser?.paymentMethod == 'AmazonPay'}">
