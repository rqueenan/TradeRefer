		...
		<div class="col-lg-12">
			<div class="wrapper wrapper-content animated fadeInRight">
				<g:if test="${invoiceInstance?.status == 'SENT' || invoiceInstance?.status == 'OVERDUE'}">
					<div id="buttonDiv">
						<g:if test="${tradesmanInstance?.amazonPayEnabled == true && tradesmanInstance?.amazon_merchantId && tradesmanInstance?.amazon_clientId && tradesmanInstance?.amazon_accessKey && tradesmanInstance?.amazon_secretKey && liUser?.paymentMethod?.contains('AmazonPay')}">
						...
						<g:if test="${tradesmanInstance?.paypalEnabled == true && tradesmanInstance?.paypal_clientId && tradesmanInstance?.paypal_clientSecret && liUser?.paymentMethod?.contains('PayPal')}">
							<div class="col-md-2" style="float: right;">
